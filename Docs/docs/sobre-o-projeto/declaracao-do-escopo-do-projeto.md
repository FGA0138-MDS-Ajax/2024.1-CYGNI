...
| 11  | Sprint 06 | Funcional | Must | O administrador deve ter acesso aos dias de trabalho específicos de cada funcionário durante o tempo de expediente. | Como administrador, desejo visualizar datas detalhadss de todos os funcionários cadastrados no sistema para facilitar a escolha de funcionários para determinado dia. |

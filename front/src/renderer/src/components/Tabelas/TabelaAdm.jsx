...
const renderBoolean = (params) => (params.value ? <span>Editor</span> : <span>Leitor</span>);
	...
	return (
		...
		>
			<DataGrid
				...
				key={windowWidth}
			/>
			{isModalOpen && <ModalPerfil open={isModalOpen} admin={selectedAdmin} isEdit={isEdit} closeModal={closeModal} />}
		</Box>
	);
}

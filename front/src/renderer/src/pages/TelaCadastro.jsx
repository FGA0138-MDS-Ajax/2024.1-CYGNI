			...
			<div className="conteudo-principal">
					...
					<div className="dados-pessoais">
						...
						<form className="formulario-cadastro" >
							<fieldset id="secao1">
								...
								<div className="linha">
									<Campo id="matricula" texto="Matrícula" tipo="text" registro={register} erros={errors} />
									<Campo id="nomeGuerra" texto="Nome de Guerra" tipo="text" registro={register} erros={errors} />
								</div>
									<Campo id="nomeCompleto" texto="Nome Completo" tipo="text" registro={register} erros={errors} />
								<div className="linha">
						...
						<div className="documentacao">
							...
							<form className="formulario-documentacao">
								<fieldset id="secao4">
									...
									<div className="linha">
										<Campo id="rg" texto="RG" tipo="text" pattern="\d{2}\.\d{3}\.\d{3}-\d{1}" registro={register} erros={errors}/>
										<Campo id="cpf" texto="CPF" tipo="text" pattern="\d{3}\.?\d{3}\.?\d{3}-?\d{2}" registro={register} erros={errors} />
										<Campo id="matSiape" texto="Mat Siape" tipo="text" registro={register} erros={errors}/>
									</div>
									<div className="linha">
						...
						<form className="formulario-ficha-gerencial">
							<fieldset id="secao6">
								...
								<div className="linha">
									...
									<Campo id="apresentacao" texto="Apresentação" tipo="text" registro={register} erros={errors}/>
									<Campo id="admissao" texto="Admissão" tipo="text" registro={register} erros={errors}/>
				...
				<div className="botoes">
					...
					<Botao
						...
						cor="#588C7E"
						largura={"130px"}
						aoClicar={(e) => { e.preventDefault(); handleSubmit(onSubmit)(); }}
					/>
				</div>
			</div>
		</div>

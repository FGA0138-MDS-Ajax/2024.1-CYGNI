      ...
      <div className="dados-pessoais">
        ...
        <form className="formulario-cadastro">
          <fieldset id='secao1'>
            <legend>Dados Pessoais</legend>
              ...
              <div className="linha">
                ...
                <MenuSuspenso id="tipoSanguineo" texto="Tipo Sanguíneo" opcoes={['AB+', 'AB-','A+', 'A-', 'B+', 'B-', 'O+', 'O-']} />
              </div>
          </fieldset>
          <fieldset id='secao2'>
          ...
          <fieldset id='secao3'>
            ...
            <MenuSuspenso id="estadoCivil" texto="Estado Civil" opcoes={['Solteiro(a)', 'Casado(a)', 'Divorciado(a)', 'Viúvo(a)']} />
          </fieldset>
        </form>
      </div>
